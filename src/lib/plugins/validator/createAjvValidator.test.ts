...
function sharedAssertions(factoryFn: typeof createAjvValidator | typeof createAjvValidatorAsync) {
  ...
  test('should create a validate function', async () => {
    const validate = await factoryFn(options)
  ...
  test('should pass additional Ajv options', async () => {
    const validate = await factoryFn({
      ...options,
      ajvOptions: {
        allErrors: false,
        loadSchema: () => Promise.resolve({})
...
describe('createAjvValidator', () => {
  sharedAssertions(createAjvValidator)
})

describe('createAjvValidatorAsync', () => {
  sharedAssertions(createAjvValidatorAsync)
