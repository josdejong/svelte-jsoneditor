...
describe('selection', () => {
  ...
  describe('navigate', () => {
    ...
    it('getSelectionRight', () => {
      assert.deepStrictEqual(getSelectionRight(json2, state2, { type: SELECTION_TYPE.KEY, path: ['path'], anchorPath: ['path'], focusPath: ['path'] }), {
        type: SELECTION_TYPE.VALUE,
        anchorPath: ['path'],
        focusPath: ['path'],
        edit: false
      ...
      assert.deepStrictEqual(getSelectionRight(json2, state2, { type: SELECTION_TYPE.VALUE, path: [], anchorPath: [], focusPath: [] }), {
        type: SELECTION_TYPE.INSIDE,
        anchorPath: [],
        focusPath: []
      })

      assert.deepStrictEqual(getSelectionRight(json2, state2, { type: SELECTION_TYPE.VALUE, path: ['path'], anchorPath: ['path'], focusPath: ['path'] }), {
        type: SELECTION_TYPE.AFTER,
        anchorPath: ['path'],
        focusPath: ['path']
      })

      assert.deepStrictEqual(getSelectionRight(json2, state2, { type: SELECTION_TYPE.AFTER, path: ['path'], anchorPath: ['path'], focusPath: ['path'] }), {
        type: SELECTION_TYPE.KEY,
        anchorPath: ['path1'],
        focusPath: ['path1'],
        edit: false
      ...
      assert.deepStrictEqual(getSelectionRight(json2, state2, { type: SELECTION_TYPE.INSIDE, path: ['path'], anchorPath: ['path'], focusPath: ['path'] }), null)
    ...
    describe('getSelectionUp', () => {
      ...
      it('should get selection up from KEY selection', () => {
        assert.deepStrictEqual(getSelectionUp(json2, state2,
      ...
      it('should get selection up from MULTI selection', () => {
        assert.deepStrictEqual(getSelectionUp(json2, state2,
          createSelection(json2, state2, { type: SELECTION_TYPE.MULTI, anchorPath: ['d'], focusPath: ['obj'] })),
        createSelection(json2, state2, { type: SELECTION_TYPE.MULTI, anchorPath: ['a'], focusPath: ['a'] }))

        assert.deepStrictEqual(getSelectionUp(json2, state2,
          createSelection(json2, state2, { type: SELECTION_TYPE.MULTI, anchorPath: ['obj'], focusPath: ['d'] })),
        createSelection(json2, state2, { type: SELECTION_TYPE.MULTI, anchorPath: ['arr', 1], focusPath: ['arr', 1] }))
      })
    })
  ...
  it('should turn selection into text', () => {
    ...
    assert.deepStrictEqual(selectionToPartialJson(json, createSelection(json, state, { anchorPath: ['str'], focusPath: ['bool'] })),
      '"str": "hello world",\n' +
      '"nill": null,\n' +
      '"bool": false,'
    )

    assert.deepStrictEqual(selectionToPartialJson(json, createSelection(json, state, { anchorPath: ['obj', 'arr', 0], focusPath: ['obj', 'arr', 1] })),
      '1,\n' +
      '2,'
    )
    assert.deepStrictEqual(selectionToPartialJson(json, createSelection(json, state, { anchorPath: ['obj', 'arr', 0], focusPath: ['obj', 'arr', 0] })), '1')
